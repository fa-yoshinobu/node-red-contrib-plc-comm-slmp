...
const CANONICAL_FAMILY_NAMES = Object.freeze({
  ...
  "iq-l": SlmpDeviceRangeFamily.IqL,
...
PROFILES[SlmpDeviceRangeFamily.IqL] = profile(
  SlmpDeviceRangeFamily.IqL,
  PROFILES[SlmpDeviceRangeFamily.IqR].registerStart,
  PROFILES[SlmpDeviceRangeFamily.IqR].registerCount,
  PROFILES[SlmpDeviceRangeFamily.IqR].rules
);
...
function familyLabel(family) {
  switch (normalizeDeviceRangeFamily(family)) {
    case SlmpDeviceRangeFamily.IqR:
      return "IQ-R";
    case SlmpDeviceRangeFamily.IqL:
      return "iQ-L";
