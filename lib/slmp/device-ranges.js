...
const PROFILES = Object.freeze({
  ...
  [SlmpDeviceRangeFamily.LCpu]: profile(SlmpDeviceRangeFamily.LCpu, 286, 26, {
    ...
    Z: word(305, "SD305", "Requires ZZ = FFFFh for the reported upper bound."),
...
function normalizeDeviceRangeFamily(value) {
  ...
  if (Object.prototype.hasOwnProperty.call(FAMILY_ALIASES, normalized)) {
...
async function readDeviceRangeCatalogForFamily(client, family, options = {}) {
  ...
  return buildDeviceRangeCatalogForFamily(normalizedFamily, registers);
}
