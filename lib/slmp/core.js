...
const PLC_FAMILY_DEFAULTS = Object.freeze({
  ...
  "iq-l": Object.freeze({ frameType: FrameType.FRAME_4E, plcSeries: PLCSeries.IQR, deviceFamily: "iq-r", rangeFamily: "iq-l" }),
...
function resolveConnectionProfile({ plcFamily, plcSeries, frameType } = {}, options = {}) {
  ...
  if (!allowManualProfile) {
    throw new ValueError(
      "plcFamily is required for the standard client profile. The normal route derives frameType, plcSeries, and address/range handling from that explicit family."
    );
  }
  return {
    plcFamily: null,
